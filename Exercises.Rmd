...
But don't worry about the last part, by now all of you classify as R experts! `r emo::ji(':blush:')`
...
## 1a. Load the data.table package and the nycflights13. As the nycflight13 package contains several datasets, we assign only those to objects we will later use.
## Your first task is to convert each dataset to data.table:
